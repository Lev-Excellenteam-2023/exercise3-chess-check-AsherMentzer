...
class game_state:
    ...
    def __init__(self):
        ...
        pawns_white = [Pawn('p', 1, index, Player.PLAYER_1) for index in range(8)]
        """""
        ...
        pawns_black = [Pawn('p', 6, index, Player.PLAYER_2) for index in range(8)]
    ...
    # 0 if white lost, 1 if black lost, 2 if stalemated, 3 if not game over
